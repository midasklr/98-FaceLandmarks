# -*- coding: utf-8 -*-
# @Time : 2020/9/10 上午11:25 
# @Author : midaskong 
# @File : face_angle.py 
# @Description: face angle prediction according to 5 landmarks: front;left;right;up;down.
...
if __name__ == '__main__':
    ...
    # testing begin
    for i in range(1):
        image_path = "/home/hwits/Documents/FaceRec/EdgeFace/LightWeightFaceDetector/images/00dffe2e5cd2328024736db908868a2f.png"
        ...
        if args.save_image:
            for b in dets:
                ...
                #     for kp in REFERENCE_FACIAL_POINTS:
                #         cv2.circle(face, (int(kp[0]), int(kp[1])), 2, (0, 0, 0), 4)
                #     name = "faces/{}.jpg".format(nums)
                #     nums += 1
